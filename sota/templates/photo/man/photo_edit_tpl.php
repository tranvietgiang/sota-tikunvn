                ...
                <?php if(isset($config['photo']['man_photo'][$type]['images_photo']) && $config['photo']['man_photo'][$type]['images_photo'] == true) { ?>
                    <div class="form-group">
                        <label class="change-photo" for="file">
                            <p>Upload hình ảnh:</p>
                            <div class="rounded">
                                <img class="rounded img-upload" src="<?=UPLOAD_PHOTO.@$item['photo']?>" onerror="src='assets/images/noimage.png'" alt="Alt Photo" <?=$type=='mangxahoi' ? 'style="background:#0076ec; padding:2px;"':''?>/>
                                <strong>
