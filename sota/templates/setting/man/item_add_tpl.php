                ...
                <div class="form-group">
                    <div class="custom-control custom-radio d-inline-block mr-3 text-md">
                        <input class="custom-control-input mailertype" type="radio" id="mailertype-host"
                            ...
                            <?=($options['mailertype']==1 || $options['mailertype']==0)?"checked":""?> value="1">
                    ...
                    <div class="custom-control custom-radio d-inline-block mr-3 text-md">
                        <input class="custom-control-input mailertype" type="radio" id="mailertype-gmail"
                            name="data[options][mailertype]" <?=($options['mailertype']==2)?"checked":""?> value="2">
                ...
                <div
                    ...
                    <div class="row">
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control" name="data[options][ip_host]" id="ip_host"
                                placeholder="Host" value="<?=$options['ip_host']?>">
                        </div>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="port_host">Port:</label>
                            <input type="text" class="form-control" name="data[options][port_host]" id="port_host"
                                placeholder="Port" value="<?=$options['port_host']?>">
                        </div>
                        <div class="form-group col-md-4 col-sm-6">
                        ...
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control" name="data[options][email_host]" id="email_host"
                                placeholder="Email host" value="<?=$options['email_host']?>">
                        </div>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="password_host">Password host:</label>
                            <input type="text" class="form-control" name="data[options][password_host]"
                ...
                <div class="gmail-email <?=($options['mailertype']==2)?'d-block':'d-none'?>">
                    <div class="row">
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control" name="data[options][host_gmail]" id="host_gmail"
                                placeholder="Host" value="<?=$options['host_gmail']?>">
                        </div>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="port_gmail">Port:</label>
                            <input type="text" class="form-control" name="data[options][port_gmail]" id="port_gmail"
                                placeholder="Port" value="<?=$options['port_gmail']?>">
                        </div>
                        <div class="form-group col-md-4 col-sm-6">
                        ...
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control" name="data[options][email_gmail]" id="email_gmail"
                                placeholder="Email" value="<?=$options['email_gmail']?>">
                        </div>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="password_gmail">Password:</label>
                            <input type="text" class="form-control" name="data[options][password_gmail]"
            ...
            <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio d-inline-block mr-3 text-md">
                            <input class="custom-control-input" type="radio" id="lang_default-<?=$k?>"
                                ...
                                <?=($k=='vi')?"checked":($k==$options['lang_default'])?"checked":""?> value="<?=$k?>">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="data[options][diachi]" id="diachi"
                            placeholder="Địa chỉ" value="<?=$options['diachi']?>">
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="email" class="form-control" name="data[options][email]" id="email"
                            placeholder="Email" value="<?=$options['email']?>">
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="data[options][hotline]" id="hotline"
                            placeholder="Hotline" value="<?=$options['hotline']?>">
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="data[options][dienthoai]" id="dienthoai"
                            placeholder="Điện thoại" value="<?=$options['dienthoai']?>">
                    </div>
                    <?php } ?>
                    <?php if(isset($config['setting']['zalo']) && $config['setting']['zalo'] == true) { ?>
                    <div class="form-group col-md-4 col-sm-6">
                        <label for="zalo">Zalo:</label>
                        <input type="text" class="form-control" name="data[options][zalo]" id="zalo" placeholder="Zalo"
                            value="<?=$options['zalo']?>">
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="data[options][oaidzalo]" id="oaidzalo"
                            placeholder="OAID Zalo" value="<?=$options['oaidzalo']?>">
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="data[options][website]" id="website"
                            placeholder="Website" value="<?=$options['website']?>">
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="data[options][tiktok]" id="tiktok"
                            placeholder="Tiktok" value="<?=$options['tiktok']?>">
                    </div>
                    <?php } ?>
                    <?php if(isset($config['setting']['copyright']) && $config['setting']['copyright'] == true) { ?>
                    <div class="form-group col-md-4 col-sm-6">
                        <label for="copyright">Copyright:</label>
                        <input type="text" class="form-control" name="data[options][copyright]" id="copyright"
                            placeholder="Copyright" value="<?=$options['copyright']?>">
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="data[options][toado]" id="toado"
                            placeholder="Link google map" value="<?=$options['toado']?>">
                    </div>
                    <?php } ?>
                    <?php if(isset($config['setting']['slogan']) && $config['setting']['slogan'] == true) { ?>
                    <div class="form-group col-md-12 col-sm-12">
                        <label for="slogan">Slogan:</label>
                        <input type="text" class="form-control" name="data[options][slogan]" id="slogan"
                            placeholder="Câu slogan" value="<?=$options['slogan']?>">
                    </div>
                    <?php } ?>
                </div>
                <?php if(isset($config['setting']['mausac']) && $config['setting']['mausac'] == true) { ?>
                <div class="row">
                    <div class="form-group col-md-4">
                        <label for="color_main">Màu chủ đạo:</label>
                        <input type="text" class="form-control jscolor" name="data[options][background][color_main]"
                            id="color_main" maxlength="7"
                            value="<?=($options['background']['color_main'])?$options['background']['color_main']:'#000000'?>">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="color_main_1">Màu nhấn:</label>
                        <input type="text" class="form-control jscolor" name="data[options][background][color_main_1]"
                            id="color_main_1" maxlength="7"
                            value="<?=($options['background']['color_main_1'])?$options['background']['color_main_1']:'#000000'?>">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="color_background">Màu nền:</label>
                        <input type="text" class="form-control jscolor"
                            name="data[options][background][color_background]" id="color_background" maxlength="7"
                            value="<?=($options['background']['color_background'])?$options['background']['color_background']:'#000000'?>">
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="data[options][toado_iframe]" id="toado_iframe" rows="5"
                        placeholder="Tọa độ google map iframe"><?=htmlspecialchars_decode($options['toado_iframe'])?></textarea>
                </div>
                <?php } ?>
                <div class="form-group">
                    <label for="analytics">Google analytics:</label>
                    <textarea class="form-control" name="data[analytics]" id="analytics" rows="5"
                        placeholder="Google analytics"><?=htmlspecialchars_decode(@$item['analytics'])?></textarea>
                </div>
                <div class="form-group">
                    <label for="mastertool">Google Webmaster Tool:</label>
                    <textarea class="form-control" name="data[mastertool]" id="mastertool" rows="5"
                        placeholder="Google Webmaster Tool"><?=htmlspecialchars_decode(@$item['mastertool'])?></textarea>
                </div>
                <div class="form-group">
                    <label for="headjs">Head JS:</label>
                    <textarea class="form-control" name="data[headjs]" id="headjs" rows="5"
                        placeholder="Head JS"><?=htmlspecialchars_decode(@$item['headjs'])?></textarea>
                </div>
                <div class="form-group">
                    <label for="bodyjs">Body JS:</label>
                    <textarea class="form-control" name="data[bodyjs]" id="bodyjs" rows="5"
                        placeholder="Body JS"><?=htmlspecialchars_decode(@$item['bodyjs'])?></textarea>
                </div>
                        ...
                        <ul class="nav nav-tabs" id="custom-tabs-three-tab-lang" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?=($k=='vi')?'active':''?>" id="tabs-lang" data-toggle="pill"
                                    href="#tabs-lang-<?=$k?>" role="tab" aria-controls="tabs-lang-<?=$k?>"
                            ...
                            <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control for-seo" name="data[ten<?=$k?>]"
                                        id="ten<?=$k?>" placeholder="Tiêu đề (<?=$k?>)" value="<?=@$item['ten'.$k]?>"
                                        <?=($k=='vi')?'required':''?>>
                                </div>
                            </div>
                            <?php } ?>
