                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="tool-action mt-2 w-clear">
                                            <?php 
                                            $sql = "select id,(select tenvi from #_product_list where id=".$items[$i]['id_list'].") as namelist,(select tenvi from #_product_cat where id=".$items[$i]['id_cat'].") as namecat from #_product_item where id=".$items[$i]['id']." ";
