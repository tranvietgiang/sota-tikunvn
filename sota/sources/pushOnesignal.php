<?php
	...
	function save_man()
	{
		...
		if($id)
		{
			...
			$d->where('id', $id);
			if($d->update('pushonesignal',$data)) $func->redirect( "index.php?com=pushOnesignal&act=man&p=".$curPage);
		...
		else
		{
			...
			if($d->insert('pushonesignal',$data)) $func->redirect( "index.php?com=pushOnesignal&act=man&p=".$curPage);
