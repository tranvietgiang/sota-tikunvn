<?php
	...
	function save_city()
	{
		...
		if($id)
		{
			...
			$d->where('id', $id);
			if($d->update('city',$data)) $func->redirect("index.php?com=places&act=man_city&p=".$curPage.$strUrl);
		...
		else
		{
			...
			if($d->insert('city',$data)) $func->redirect("index.php?com=places&act=man_city&p=".$curPage.$strUrl);
	...
	function delete_city()
	{
		...
		if($id)
		{
			...
			if($row['id'])
			{
				...
				$func->redirect("index.php?com=places&act=man_city&p=".$curPage.$strUrl);
			}
	...
	function save_district()
	{
		...
		if($id)
		{
			...
			$d->where('id', $id);
			if($d->update('district',$data)) $func->redirect("index.php?com=places&act=man_district&p=".$curPage.$strUrl);
		...
		else
		{
			...
			if($d->insert('district',$data)) $func->redirect("index.php?com=places&act=man_district&p=".$curPage.$strUrl);
	...
	function delete_district()
	{
		...
		if($id)
		{
			...
			if($row['id'])
			{
				...
				$func->redirect("index.php?com=places&act=man_district&p=".$curPage.$strUrl);
			}
	...
	function save_wards()
	{
		...
		if($id)
		{
			...
			$d->where('id', $id);
			if($d->update('wards',$data)) $func->redirect("index.php?com=places&act=man_wards&p=".$curPage.$strUrl);
		...
		else
		{
			...
			if($d->insert('wards',$data)) $func->redirect("index.php?com=places&act=man_wards&p=".$curPage.$strUrl);
	...
	function delete_wards()
	{
		...
		if($id)
		{
			...
			if($row['id'])
			{
				...
				$func->redirect("index.php?com=places&act=man_wards&p=".$curPage.$strUrl);
			}
	...
	function save_street()
	{
		...
		if($id)
		{
			...
			$d->where('id', $id);
			if($d->update('street',$data)) $func->redirect("index.php?com=places&act=man_street&p=".$curPage.$strUrl);
		...
		else
		{
			...
			if($d->insert('street',$data)) $func->redirect("index.php?com=places&act=man_street&p=".$curPage.$strUrl);
	...
	function delete_street()
	{
		...
		if($id)
		{
			...
			if($row['id'])
			{
				...
				$func->redirect("index.php?com=places&act=man_street&p=".$curPage.$strUrl);
			}
