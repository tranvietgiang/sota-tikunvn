<?php
	...
	function get_item()
	{
		global $d, $func, $strUrl, $curPage, $item, $gallery, $type, $com, $act, $getRating;
	...
	function save_item()
	{
		...
		if($id && $act!='save_copy')
		{
			...
			if($rank != null && $rank != ''){
				...
				if(count($getRatingWithId)){		
					$d->rawQuery("delete from #_danhgia where id_product = ? and rating < ".$rank,array($id));
				}
			}
