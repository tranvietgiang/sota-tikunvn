<?php
	...
	function save_item()
	{
		...
		if($id)
		{
			...
			$d->where('id', $id);
			$d->where('type', $type);
			if($d->update('newsletter',$data)) $func->redirect("index.php?com=newsletter&act=man&type=".$type."&p=".$curPage);
		...
		else
		{
			...
			if($d->insert('newsletter',$data)) $func->redirect("index.php?com=newsletter&act=man&type=".$type."&p=".$curPage);
	...
	function delete_item()
	{
		...
		if($id)
		{
			...
			if($row['id'])
			{
				...
				$func->redirect("index.php?com=newsletter&act=man&type=".$type."&p=".$curPage);
			}
